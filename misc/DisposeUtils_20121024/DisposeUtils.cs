namespace Yoheie.DisposeUtils
{
    ...
    class ExampleBase : System.IDisposable
    {
        ...
        public void SampleBasePublicMethod()
        {
            // Dispose 済みかチェック
            disposer.ThrowExceptionIfDisposed();

            // SampleBasePublicMethod の処理
        }
    }
    ...
    class ExampleDerived : ExampleBase
    {
        ...
        private void ReleaseBase(bool disposing)
        {
        ...
        public void SampleDerivedPublicMethod()
        {
            // Dispose 済みかチェック
            disposer.ThrowExceptionIfDisposed();

            // SampleDerivedPublicMethod の処理
        }
    }
}
